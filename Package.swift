...
let package = Package(name: "SwiftFoundationExtensions",
                      products: [
                          // Products define the executables and libraries produced by a package,
                          // and make them visible to other packages.
                          .library(name: "SwiftFoundationExtensions",
                      ...
                      targets: [
                          ...
                          .target(name: "SwiftFoundationExtensions",
                                  dependencies: []),
                          .testTarget(name: "SwiftFoundationExtensionsTests",
